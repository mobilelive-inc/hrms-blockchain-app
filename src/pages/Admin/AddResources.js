...
class AddResources extends Component {
  ...
  handleSubmit = async (e) => {
    e.preventDefault();
    const { name, description, client, start_date,end_date,tokenId } = this.state;
          ...
          <Card className="card-style">
            <Card.Content>
              <Card.Header centered>
                <h2 className="card-heading">Add Resource</h2>
              </Card.Header>
              ...
              <Form error={!!this.state.errorMessage}>
                ...
                <br />
                <Form.Field  style={{display:"flex",justifyContent:"center"}} className="form-inputs-admin">
                  <DatePicker
                  id="start_date"
